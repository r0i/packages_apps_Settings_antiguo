...
public class StatusBarClockStyle extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createCustomView() {
        ...
        mStatusBarClockColorOverride = (SwitchPreference) prefSet.findPreference(PREF_COLOR_OVERRIDE);
        mStatusBarClockColorOverride.setChecked((Settings.System.getInt(
                getActivity().getApplicationContext().getContentResolver(),
                Settings.System.STATUSBAR_CLOCK_COLOR_OVERRIDE, 0) == 1));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mClockAmPmStyle) {
            ...
            Settings.System.putInt(getActivity().getApplicationContext().getContentResolver(),
                    Settings.System.STATUSBAR_CLOCK_COLOR_OVERRIDE,
                    (Boolean) newValue ? 1 : 0);
            return true;
